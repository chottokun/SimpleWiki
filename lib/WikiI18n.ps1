...
$script:I18n = @{
    "ja" = @{
        ...
        "editor_delete_doc_confirm" = "本当にこのドキュメントを削除しますか？`n削除された内容はバックアップされますが、一覧から削除されます。`n対象: {0}"
        "editor_upload_error_type"  = "許可されていない画像形式です。PNG, JPG, GIF, WEBP のみ対応しています。"
        "editor_upload_error_size"  = "画像サイズが上限(15MB)を超えています。"
    ...
    "en" = @{
        ...
        "editor_delete_doc_confirm" = "Are you sure you want to delete this document?`nPath: {0}"
        "editor_upload_error_type"  = "Unsupported image format. Only PNG, JPG, GIF, and WEBP are supported."
        "editor_upload_error_size"  = "Image size exceeds the 15MB limit."
