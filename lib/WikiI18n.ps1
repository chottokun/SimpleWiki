...
$script:I18n = @{
    "ja" = @{
        ...
        "editor_field_status"       = "ステータス:"
        "editor_status_stable"      = "🟢 stable (安定・推奨)"
        "editor_status_active"      = "✅ active (現行)"
        "editor_status_draft"       = "🟡 draft (下書き)"
        "editor_status_review"      = "🔍 review (レビュー中)"
        "editor_status_deprecated"  = "🔴 deprecated (非推奨)"
        "editor_status_archived"    = "📦 archived (アーカイブ)"
    ...
    "en" = @{
        ...
        "editor_field_status"       = "Status:"
        "editor_status_stable"      = "🟢 stable (Stable)"
        "editor_status_active"      = "✅ active (Active)"
        "editor_status_draft"       = "🟡 draft (Draft)"
        "editor_status_review"      = "🔍 review (Review)"
        "editor_status_deprecated"  = "🔴 deprecated (Deprecated)"
        "editor_status_archived"    = "📦 archived (Archived)"
