...
$script:I18n = @{
    "ja" = @{
        ...
        "tag_docs_heading"          = "🏷️ タグ 「{0}」 のドキュメント ({1}件)"
        "tag_empty_msg"             = "該当するドキュメントはありません。"
        "tag_none_registered"       = "登録されているタグはありません。"
        "tag_glossary_title"        = "📖 用語解説: {0}"
        ...
        "author_docs_heading"       = "👤 著者 「{0}」 のドキュメント ({1}件)"
        "author_empty_msg"          = "該当するドキュメントはありません。"
        "author_none_registered"    = "登録されている著者はありません。"
        "filter_banner_tag"         = "🏷️ タグ <strong>「{0}」</strong> で絞り込み中 ({1}件)"
        "filter_banner_author"      = "👤 著者 <strong>「{0}」</strong> で絞り込み中 ({1}件)"
        "filter_banner_clear"       = "[すべてのドキュメントを表示]"
        ...
        "btn_new_doc"               = "＋ 新規作成"
        "modal_new_doc_title"       = "新規ドキュメントの作成"
        "modal_new_doc_folder"      = "保存先フォルダ:"
        "modal_new_doc_select_folder"     = "フォルダを選択:"
        "modal_new_doc_create_new_folder" = "＋ 新しいフォルダを作成..."
        "modal_new_doc_custom_folder"    = "新しいフォルダ名:"
        "modal_new_doc_new_folder_hint"   = "💡 新しいフォルダのトップページ (index.md) として作成されます。"
        "sidebar_add_doc_tooltip"         = "このフォルダ内にドキュメントを追加"
        "modal_new_doc_filename"    = "ファイル名 (.md):"
        "modal_new_doc_page_title"  = "ドキュメントタイトル:"
        "modal_new_doc_submit"      = "作成して編集を開始"
        "modal_new_doc_cancel"      = "キャンセル"
        "modal_new_doc_exists"      = "同名のファイルが既に存在します。"
        "editor_unsaved_confirm"    = "未保存の変更があります。破棄してもよろしいですか？"
        "editor_delete_doc_btn"     = "🗑️ ページを削除"
        "editor_delete_doc_confirm" = "本当にこのドキュメントを削除しますか？\n削除された内容はバックアップされますが、一覧から削除されます。\n対象: {0}"
        "editor_delete_doc_done"    = "ドキュメントを削除しました。"
        "editor_upload_error_type"  = "許可されていない画像形式です。PNG, JPG, GIF, WEBP のみ対応しています。"
        "editor_upload_error_size"  = "画像サイズが上限(10MB)を超えています。"
        "editor_uploading"          = "画像をアップロード中..."
        "editor_upload_failed"      = "画像のアップロードに失敗しました: {0}"
        ...
        "editor_meta_section_title" = "ℹ️ ドキュメント メタデータ (OKF)"
        "editor_mode_form"          = "📋 フォーム入力"
        "editor_mode_raw"           = "📄 RAW YAML"
        "editor_field_type"         = "種別 (Type):"
        "editor_field_title"        = "タイトル:"
        "editor_field_status"       = "ステータス (OKF):"
        "editor_status_draft"       = "🟡 draft (下書き)"
        "editor_status_stable"      = "🟢 stable (安定・公開)"
        "editor_status_deprecated"  = "🔴 deprecated (非推奨)"
        "editor_field_version"      = "バージョン:"
        "editor_field_domain"       = "ドメイン:"
        "editor_field_author"       = "著者:"
        "editor_field_reviewer"     = "レビュアー:"
        "editor_field_last_updated" = "更新日 (Last Updated):"
        "editor_set_today"          = "📅 今日をセット"
        "editor_field_desc"         = "概要 (Description):"
        "editor_field_tags"         = "タグ (カンマ区切り):"
        "editor_field_related"      = "関連ドキュメント (カンマ区切り):"
        "editor_field_superseded"   = "後継ドキュメント (Superseded By):"
        "editor_auto_date"          = "保存時に更新日を今日 ({0}) に自動セット"
        "editor_body_placeholder"   = "Markdown 本文を記述してください (YAML は不要)..."
        "editor_shortcut_hint"      = "💡 Ctrl+S で保存 / Esc で閉じる"
        "editor_fullscreen"         = "⛶ 最大化"
        "editor_restore"            = "🗗 元に戻す"
        ...
        "editor_meta_toggle_hint"   = "(クリックで開閉)"
        "settings_title"                = "⚙️ システム設定"
        "settings_desc"             = "検索キャッシュや起動時動作、LLM/RAG連携の各種オプションを設定します。"
        "settings_editor_title"        = "✏️ エディター設定"
        "settings_editor_enable"       = "エディター機能（ドキュメント編集・保存）を有効化する"
        "settings_editor_desc"         = "有効にすると UI 上に「✏️ 編集」ボタンが表示され、ブラウザ上での直接編集・保存が可能になります。無効にすると閲覧専用（読み取り専用モード）になります。"
        "settings_editor_type"         = "エディタエンジン:"
        "settings_editor_type_desc"    = "Markdown 編集に使用するエディタを選択します。"
        "settings_editor_type_toastui" = "TOAST UI Editor (WYSIWYG & Markdown)"
        "settings_editor_type_textarea"= "Standard Textarea (Text)"
        "settings_editor_max_backups"  = "バックアップ保存世代数 (0で無効):"
        "settings_editor_disabled_msg" = "エディター機能は無効化されています。"
        ...
        "stella_preset_3d"          = "🌌 3D 銀河"
        "stella_preset_top"         = "🗺️ 意味マップ"
        "stella_preset_timeline"    = "⏳ タイムライン"
        "stella_time_past"          = "過去"
        "stella_time_present"       = "現在"
        "stella_help_drag"          = "🖱️ ドラッグ: 3D回転 / Shift+ドラッグ: 移動"
    ...
    "en" = @{
        ...
        "tag_docs_heading"          = "🏷️ Documents tagged '{0}' ({1} items)"
        "tag_empty_msg"             = "No matching documents found."
        "tag_none_registered"       = "No registered tags found."
        "tag_glossary_title"        = "📖 Glossary: {0}"
        ...
        "author_docs_heading"       = "👤 Documents by '{0}' ({1} items)"
        "author_empty_msg"          = "No matching documents found."
        "author_none_registered"    = "No registered authors found."
        "filter_banner_tag"         = "🏷️ Filtering by tag <strong>'{0}'</strong> ({1} items)"
        "filter_banner_author"      = "👤 Filtering by author <strong>'{0}'</strong> ({1} items)"
        "filter_banner_clear"       = "[Show all documents]"
        ...
        "btn_new_doc"               = "＋ New Page"
        "modal_new_doc_title"       = "Create New Document"
        "modal_new_doc_folder"      = "Folder:"
        "modal_new_doc_select_folder"     = "Select Folder:"
        "modal_new_doc_create_new_folder" = "＋ Create New Folder..."
        "modal_new_doc_custom_folder"    = "New Folder Name:"
        "modal_new_doc_new_folder_hint"   = "💡 Will be created as the top page (index.md) of the new folder."
        "sidebar_add_doc_tooltip"         = "Add document inside this folder"
        "modal_new_doc_filename"    = "File Name (.md):"
        "modal_new_doc_page_title"  = "Document Title:"
        "modal_new_doc_submit"      = "Create & Start Editing"
        "modal_new_doc_cancel"      = "Cancel"
        "modal_new_doc_exists"      = "A document with the same name already exists."
        "editor_unsaved_confirm"    = "You have unsaved changes. Discard them?"
        "editor_delete_doc_btn"     = "🗑️ Delete Page"
        "editor_delete_doc_confirm" = "Are you sure you want to delete this document?\nA backup will be saved, but the document will be removed from navigation.\nTarget: {0}"
        "editor_delete_doc_done"    = "Document deleted successfully."
        "editor_upload_error_type"  = "Unsupported image format. Only PNG, JPG, GIF, and WEBP are supported."
        "editor_upload_error_size"  = "Image size exceeds the 10MB limit."
        "editor_uploading"          = "Uploading image..."
        "editor_upload_failed"      = "Failed to upload image: {0}"
        ...
        "editor_meta_section_title" = "ℹ️ Document Metadata (OKF)"
        "editor_mode_form"          = "📋 Form View"
        "editor_mode_raw"           = "📄 RAW YAML"
        "editor_field_type"         = "Type:"
        "editor_field_title"        = "Title:"
        "editor_field_status"       = "Status (OKF):"
        "editor_status_draft"       = "🟡 draft (Draft)"
        "editor_status_stable"      = "🟢 stable (Stable)"
        "editor_status_deprecated"  = "🔴 deprecated (Deprecated)"
        "editor_field_version"      = "Version:"
        "editor_field_domain"       = "Domain:"
        "editor_field_author"       = "Author:"
        "editor_field_reviewer"     = "Reviewer:"
        "editor_field_last_updated" = "Last Updated:"
        "editor_set_today"          = "📅 Set to Today"
        "editor_field_desc"         = "Description:"
        "editor_field_tags"         = "Tags (comma separated):"
        "editor_field_related"      = "Related Docs (comma separated):"
        "editor_field_superseded"   = "Superseded By:"
        "editor_auto_date"          = "Auto-update date to today ({0}) on save"
        "editor_body_placeholder"   = "Write Markdown body content here (no YAML needed)..."
        "editor_shortcut_hint"      = "💡 Ctrl+S to save / Esc to cancel"
        "editor_fullscreen"         = "⛶ Maximize"
        ...
        "editor_meta_toggle_hint"   = "(Click to toggle)"
        "settings_title"                = "⚙️ System Settings"
        "settings_desc"             = "Configure search cache, startup behavior, and LLM/RAG integration options."
        "settings_editor_title"        = "✏️ Editor Settings"
        "settings_editor_enable"       = "Enable editor features (document editing & saving)"
        "settings_editor_desc"         = "When enabled, an '✏️ Edit' button will appear in the UI allowing in-browser editing and saving. When disabled, the Wiki operates in read-only mode."
        "settings_editor_type"         = "Editor Engine:"
        "settings_editor_type_desc"    = "Select the editor engine used for Markdown editing."
        "settings_editor_type_toastui" = "TOAST UI Editor (WYSIWYG & Markdown)"
        "settings_editor_type_textarea"= "Standard Textarea (Text)"
        "settings_editor_max_backups"  = "Backup generations to keep (0 to disable):"
        "settings_editor_disabled_msg" = "Editor feature is disabled."
        ...
        "stella_preset_3d"          = "🌌 3D Galaxy"
        "stella_preset_top"         = "🗺️ Semantic Map"
        "stella_preset_timeline"    = "⏳ Timeline"
        "stella_time_past"          = "Past"
        "stella_time_present"       = "Present"
        "stella_help_drag"          = "🖱️ Drag: 3D Orbit / Shift+Drag: Pan"
